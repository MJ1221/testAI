...
import searchLookupData from '@salesforce/apex/bsnsTripRprtLookup.searchLookupData';
import searchDefaultRecord from '@salesforce/apex/bsnsTripRprtLookup.searchDefaultRecord';
...
export default class CustomLookup extends LightningElement {
  ...
  // update searchKey property on input field change  
    ...
    handelSelectedRecord(event){   
        ...
        console.log('select Record===>', objId);
        console.log('select Record===>', JSON.stringify(this.selectedRecord));
